...
DEFAULT_OPENROUTER_MODEL: typing.Final = "anthropic/claude-haiku-4.5"
...
DEFAULT_CLEAN_CONFIDENCE_THRESHOLD: typing.Final = 0.78
DEFAULT_RISK_FAST_ACCEPT_CONFIDENCE_THRESHOLD: typing.Final = 0.86
