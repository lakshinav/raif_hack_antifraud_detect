...
DEFAULT_OPENROUTER_MODEL: typing.Final = "qwen/qwen3.6-35b-a3b" #"anthropic/claude-opus-4.8-fast"
DEFAULT_SECONDARY_OPENROUTER_MODEL: typing.Final = "google/gemini-3.5-flash" # "anthropic/claude-sonnet-4.6"
...
DEFAULT_RISK_CONFIDENCE_THRESHOLD: typing.Final = 0.75
DEFAULT_CLEAN_CONFIDENCE_THRESHOLD: typing.Final = 0.80
DEFAULT_RISK_FAST_ACCEPT_CONFIDENCE_THRESHOLD: typing.Final = 0.85
DEFAULT_RISK_SECONDARY_CONFIDENCE_THRESHOLD: typing.Final = 0.82
