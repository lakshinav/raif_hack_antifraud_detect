...
class OpenRouterClient:
    def __init__(self, app_settings: AppSettings | None = None) -> None:
        ...
        app_logger.info(
            "OpenRouter client configured: model=%s timeout=%s api_key_configured=%s",
            self.app_settings.openrouter_model,
    ...
    def request_completion(self, prompt_text: str, *, json_mode: bool = True) -> str | None:
        ...
        try:
            ...
            app_logger.warning("OpenRouter request failed: %s", http_error)
            return None
